...
TypeIcdToads2 ={'SPAR': ('int32',4),
                 ...
                 'BYTES':  ('uint64',      8),  # ('byte',1)modify this for comac test 
                 'STRING': ('string',    1),}
...
class CVTConnect(object):
    ...
    def add_664_signal(self,msg,sig):
        ...
        if sig['direct'] == 'Input':            
            ...
            alias.append(name)
        alias.append(name) # add this for comac test, all the output input will add this alias
        #else:
        ...
        if sig['SigType'] == "STRING": #sig['SigType'] == "BYTES" or sig['SigType'] == "STRING": modi
