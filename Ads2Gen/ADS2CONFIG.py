...
import sys
import time
sys.path.append("D:\workspace\ADS2\Ads2_6.2_2")
import getopt
...
sys.path.append("D:\workspace\ADS2\Ads2_6.2_2\C919_ICD_Processor")
    ...
    def add_664_signal(self,msg,sig):
        ...
        if sig['direct'] == 'Input':            
            ...
            if finalpara.lower() in ['label','ssm','parity','pad','sdi']:
                ...
                name = message['fullname']+'.'+sig['Pubref']
                #else:
                #name = 
                #print name
        ...
        if 'arinc 661' in message['MsgDataProtocolType'].lower():
            newpoint.elements = message['TXLength']
...
def ProcessExcel(workdir,outdir, hfnamelist,platform,merge,mode,devmapfile,split):
    ...
    if merge == True:
        ...
        #print AnalysisRecord.inputafdxsignal
