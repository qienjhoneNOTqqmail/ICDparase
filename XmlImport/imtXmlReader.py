...
import os
import fnmatch
sys.path.append("D:\workspace\ADS2\Ads2_6.2.3")
...
def icdGetNodePaths(Node,inputres):
    inputres = inputres+'.'+ Node.tag
    ...
    if len(children)== 0:
        ...
        for child in children:
           icdGetNodePaths(child,inputres)
        return
...
def icdReadAll(dirOrFileList, exclude=None):
    ...
    #DPpath = [c for c in All_Paths if 'CANMessage' in c ]
    #print(All_Paths)
    return xroot
